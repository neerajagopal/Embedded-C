...
void initHw()
{
    ...
    GPIO_PORTF_DEN_R = 0x1C;  // enable LEDs and pushbuttons
    GPIO_PORTF_PUR_R = 0x10;  // enable internal pull-up for push button

    // Configure keyboard
    // Columns 0-3 connected through diodes to PA6, PA7, PD2, PD3
    ...
    GPIO_PORTD_DEN_R |= 0x0C;  // bits 6 and 7 are digital
